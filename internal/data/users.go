...
// The Set() method calculates the bcrypt hash of a plaintext password, and stores both the hash and plaintext version in the struct
...
func (m UserModel) GetForToken(scope string, token string) (*User, error) {
	...
	args := []interface{}{tokenHash[:], scope, time.Now().UTC()}
